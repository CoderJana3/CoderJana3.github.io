...
authBtn.addEventListener("click", async () => {
    console.log("got to 3rdParty authorize.js");   //try changing fetch post to fetch get and check if that method is also not allowed (github pages only does get methods)
